...
class CommandRouter:
    ...
    def basic(self):
        ...
        if self._basic is None:
            from qwen_cli.handlers.basic import BasicCommandHandler
    ...
    def agents(self):
        ...
        if self._agents is None:
            from qwen_cli.handlers.agents import AgentCommandHandler
    ...
    def claude_parity(self):
        ...
        if self._claude_parity is None:
            from qwen_cli.handlers.claude_parity import ClaudeParityHandler
    ...
    def session(self):
        ...
        if self._session is None:
            from qwen_cli.handlers.session import SessionCommandHandler
    ...
    def operations(self):
        ...
        if self._operations is None:
            from qwen_cli.handlers.operations import OperationsHandler
