...
Usage:
    ...
    from qwen_dev_cli.third_party.justica import EnforcementMode
...
Integration Points:
    ...
    - Audit: Transparent logging to qwen_dev_cli logs
...
Always provide clear reasoning for your decisions."""
    ...
    def _setup_audit_logger(self, backend: str) -> AuditLogger:
        ...
        if backend == "console":
            ...
            from ..third_party.justica import InMemoryBackend
